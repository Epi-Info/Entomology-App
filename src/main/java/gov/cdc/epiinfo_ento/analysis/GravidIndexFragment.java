...
public class GravidIndexFragment extends Fragment {

    private OnFragmentInteractionListener mListener;
    private LinearLayout content;

    public GravidIndexFragment() {

    }

    public static GravidIndexFragment newInstance(String param1, String param2) {
        GravidIndexFragment fragment = new GravidIndexFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_gravid_index, container, false);
        content = v.findViewById(R.id.rate_content);

        SetupGadget();

        if (mListener != null) {
            mListener.onFragmentInteraction(getString(R.string.dash_gravid_index));
        }
    ...
    private void SetupGadget() {
        ...
        dbHelper.open();
        Cursor c = dbHelper.getGravidIndex();
