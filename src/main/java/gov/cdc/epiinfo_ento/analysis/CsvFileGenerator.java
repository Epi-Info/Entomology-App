...
public class CsvFileGenerator {
	...
	private class Generator extends AsyncTask<Void,Void,Boolean>
	{
		...
		protected void onPostExecute(Boolean success)
		{
			if (success)
			{
				File file = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS)+"/EpiInfoEntomology/Output/" + viewName + ".csv");
		...
		protected Boolean doInBackground(Void... params) {
			...
			try
			{
				...
				path.mkdirs();
				File tempPath = new File(path, "/EpiInfoEntomology/Output/");
				tempPath.mkdirs();
				fileWriter = new FileWriter(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS)+"/EpiInfoEntomology/Output/" + viewName + ".csv");
