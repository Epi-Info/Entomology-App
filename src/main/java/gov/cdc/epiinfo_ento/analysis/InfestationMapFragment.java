 ...
 * {@link InfestationMapFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link InfestationMapFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class InfestationMapFragment extends Fragment implements OnMapReadyCallback {
    ...
    public InfestationMapFragment() {

    }

    public static InfestationMapFragment newInstance(String param1, String param2) {
        InfestationMapFragment fragment = new InfestationMapFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_infestation_map, container, false);

        if (mListener != null) {
            mListener.onFragmentInteraction(getString(R.string.dash_inf_map));
        }
    ...
    private void SetupGadget(GoogleMap googleMap) {
        ...
        dbHelper.open();
        Cursor c = dbHelper.getInfestationMap();
