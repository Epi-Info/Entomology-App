...
public class GravidDensityFragment extends Fragment {

    private OnFragmentInteractionListener mListener;
    private LinearLayout content;

    public GravidDensityFragment() {

    }

    public static GravidDensityFragment newInstance(String param1, String param2) {
        GravidDensityFragment fragment = new GravidDensityFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_gravid_density, container, false);
        content = v.findViewById(R.id.rate_content);

        SetupGadget();

        if (mListener != null) {
            mListener.onFragmentInteraction(getString(R.string.dash_gravid_density));
        }
    ...
    private void SetupGadget() {
        ...
        dbHelper.open();
        Cursor c = dbHelper.getGravidDensity();

        if (c.moveToFirst()) {
            do {

                double a = c.getDouble(c.getColumnIndexOrThrow("TotalAdults"));
                double b = c.getDouble(c.getColumnIndexOrThrow("TotalTraps"));

                double index = 1.0 * c.getDouble(c.getColumnIndexOrThrow("TotalAdults")) / c.getDouble(c.getColumnIndexOrThrow("TotalTraps"));
