...
public class HouseIndexFragment extends Fragment {
    ...
    public HouseIndexFragment() {

    }

    public static HouseIndexFragment newInstance(String param1, String param2) {
        HouseIndexFragment fragment = new HouseIndexFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_house_index, container, false);
        content = v.findViewById(R.id.rate_content);

        SetupGadget();

        if (mListener != null) {
            mListener.onFragmentInteraction(getString(R.string.dash_house_index));
        }
    ...
    private void SetupGadget() {
        ...
        dbHelper.open();
        Cursor c = dbHelper.getHouseIndex();

        if (c.moveToFirst()) {
            do {

                double index = 100.0 * c.getDouble(c.getColumnIndexOrThrow("PositiveHouses")) / c.getDouble(c.getColumnIndexOrThrow("TotalHouses"));
