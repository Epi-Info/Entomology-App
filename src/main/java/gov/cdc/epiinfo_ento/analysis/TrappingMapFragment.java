...
public class TrappingMapFragment extends Fragment implements OnMapReadyCallback {
    ...
    public TrappingMapFragment() {

    }

    public static TrappingMapFragment newInstance(String param1, String param2) {
        TrappingMapFragment fragment = new TrappingMapFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_trapping_map, container, false);

        if (mListener != null) {
            mListener.onFragmentInteraction(getString(R.string.dash_trapping_map));
        }
    ...
    private void SetupGadget(GoogleMap googleMap) {
        ...
        dbHelper.open();
        Cursor c = dbHelper.getTrappingActivityMap();
