...
public class Preloader {
    ...
    private void LoadData()
    {
        ...
        File quesPath = new File(basePath + "/EpiInfoEntomology/Preload");
        ...
        if (files != null)
        {
            for (int x=0;x<files.length;x++)
            {
                ...
                try {
                    ...
                    FormMetadata formMetadata = new FormMetadata("EpiInfoEntomology/Questionnaires/"+ viewName +".xml", context);
                    ...
                    br = new BufferedReader(new InputStreamReader(new FileInputStream(quesPath + "/" + csvFile),"ISO-8859-1"));//new FileReader(quesPath + "/" + csvFile));
